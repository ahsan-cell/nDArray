...
{ 
	...
	cout << "---------------------------------------\n";
	cout << a1;                    //testing << operator

	cout << "---------------------------------------\n";
	cout << a1(1, 1, 10)<<endl;
	a1(1, 1, 1) = 100;              //testing () operator
	cout << a1(1, 1, 1)<<endl;

	cout << "---------------------------------------\n";
	ndArray<int> a2(a1);            //testing copy constructor
	cout << a2;
	
	cout << "---------------------------------------\n";
	a1.Delete(5);                    //testing delete functions
	cout << a1;                      
	...
	cout << "---------------------------------------\n";
	a1.Extend();                      //testing extend function
	cout << a1;
	
	cout << "---------------------------------------\n";
	a1.Shrink();                      //testing shrink function
	cout << a1;

	cout << "---------------------------------------\n";
	cout << a1.Retrieve(100)<<endl;    //testing retrieve       

	cout << "---------------------------------------\n";
	//creating a 4d array for testing
	int arr4[4] = { 2,1,2,2 };
	int indexes[4] = { 0,0,0,0 };
	ndArray<int> a3(arr4,4);
	int x = 1;
	//using loops to store values at each index
	for (int i = 0; i <  2; i++)
	{
		for (int j = 0; j < 1; j++)
		{
